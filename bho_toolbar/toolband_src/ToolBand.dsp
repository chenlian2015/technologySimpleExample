...
!MESSAGE "ToolBand - Win32 Unicode Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ToolBand - Win32 Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ToolBand - Win32 Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ToolBand - Win32 Unicode Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "ToolBand - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\ToolBand.dll
InputPath=.\Debug\ToolBand.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ToolBand - Win32 Unicode Debug"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\ToolBand.dll
InputPath=.\DebugU\ToolBand.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ToolBand - Win32 Release MinSize"
...
# ADD CPP /nologo /MT /W3 /GX /O1 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_ATL_DLL" /FR /Yu"stdafx.h" /FD /c
...
TargetPath=.\ReleaseMinSize\ToolBand.dll
InputPath=.\ReleaseMinSize\ToolBand.dll
SOURCE="$(InputPath)"
...
TargetPath=.\ReleaseMinDependency\ToolBand.dll
InputPath=.\ReleaseMinDependency\ToolBand.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ToolBand - Win32 Unicode Release MinSize"
...
TargetPath=.\ReleaseUMinSize\ToolBand.dll
InputPath=.\ReleaseUMinSize\ToolBand.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "ToolBand - Win32 Unicode Release MinDependency"
...
TargetPath=.\ReleaseUMinDependency\ToolBand.dll
InputPath=.\ReleaseUMinDependency\ToolBand.dll
SOURCE="$(InputPath)"
...
# Name "ToolBand - Win32 Unicode Debug"
# Name "ToolBand - Win32 Release MinSize"
# Name "ToolBand - Win32 Release MinDependency"
# Name "ToolBand - Win32 Unicode Release MinSize"
# Name "ToolBand - Win32 Unicode Release MinDependency"
# Begin Group "Source Files"

# PROP Default_Filter "cpp;c;cxx;rc;def;r;odl;idl;hpj;bat"
# Begin Source File

SOURCE=.\BandEditCtrl.cpp
# End Source File
# Begin Source File
...
SOURCE=.\ToolBand.idl
# ADD MTL /tlb ".\ToolBand.tlb" /h "ToolBand.h" /iid "ToolBand_i.c" /Oicf
# End Source File
# Begin Source File
