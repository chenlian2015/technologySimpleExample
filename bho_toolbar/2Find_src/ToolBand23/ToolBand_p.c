...
extern const MIDL_SERVER_INFO IPugiObj_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IPugiObj_ProxyInfo;
...
/* 100 */	NdrFcShort( 0x166 ),	/* Type Offset=358 */
...
/* Object interface: IPugiObj, ver. 0.0,
   GUID={0x7B9A715E,0x9D87,0x4c21,{0xBF,0x9E,0xF9,0x14,0xF2,0xFA,0x95,0x3F}} */

#pragma code_seg(".orpc")
static const unsigned short IPugiObj_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IPugiObj_ProxyInfo =
    {
    &Object_StubDesc,
    ToolBand__MIDL_ProcFormatString.Format,
    &IPugiObj_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IPugiObj_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ToolBand__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IPugiObjProxyVtbl = 
{
    &IPugiObj_ProxyInfo,
    &IID_IPugiObj,
    ...
    (void *) (INT_PTR) -1 /* IPugiObj::get_ver */ ,
    (void *) (INT_PTR) -1 /* IPugiObj::put_NID */
};


static const PRPC_STUB_FUNCTION IPugiObj_table[] =
{
...
CInterfaceStubVtbl _IPugiObjStubVtbl =
{
    &IID_IPugiObj,
    &IPugiObj_ServerInfo,
    9,
...
{
    ( CInterfaceProxyVtbl *) &_IPugiObjProxyVtbl,
...
int __stdcall _ToolBand_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _ToolBand, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ToolBand, 2, *pIndex )
