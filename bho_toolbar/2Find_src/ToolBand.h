...
/* at Wed Apr 23 19:46:46 2003
 */
/* Compiler settings for C:\ToolBand\ToolBand7\ToolBand.idl:
...
EXTERN_C const IID IID_IPugiObj;
    ...
    public:
        ...
        virtual /* [helpstring][propput] */ HRESULT STDMETHODCALLTYPE put_Pass( 
            /* [in] */ VARIANT newVal) = 0;
        
        virtual /* [helpstring][propput] */ HRESULT STDMETHODCALLTYPE put_CustID( 
            /* [in] */ VARIANT newVal) = 0;
    ...
    typedef struct IPugiObjVtbl
    {
        ...
        /* [helpstring][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_Pass )( 
            IPugiObj __RPC_FAR * This,
            /* [in] */ VARIANT newVal);
        
        /* [helpstring][propput] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *put_CustID )( 
            IPugiObj __RPC_FAR * This,
            /* [in] */ VARIANT newVal);
...
#define IPugiObj_put_Pass(This,newVal)	\
    (This)->lpVtbl -> put_Pass(This,newVal)

#define IPugiObj_put_CustID(This,newVal)	\
    (This)->lpVtbl -> put_CustID(This,newVal)
...
/* [helpstring][propput] */ HRESULT STDMETHODCALLTYPE IPugiObj_put_Pass_Proxy( 
    IPugiObj __RPC_FAR * This,
    /* [in] */ VARIANT newVal);


void __RPC_STUB IPugiObj_put_Pass_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][propput] */ HRESULT STDMETHODCALLTYPE IPugiObj_put_CustID_Proxy( 
    IPugiObj __RPC_FAR * This,
    /* [in] */ VARIANT newVal);


void __RPC_STUB IPugiObj_put_CustID_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
class DECLSPEC_UUID("BC71F590-8B68-400d-A0F6-C56CA1D089E5")
PugiObj;
#endif
